...
- [terraform provider onelogin](#terraform-provider-onelogin)
  ...
  - [Provider Resources](#provider-resources)
    - [onelogin\_api\_authorizations](#onelogin_api_authorizations)
    ...
    - [onelogin\_apps](#onelogin_apps)
      ...
      - [Import](#import-1)
    - [onelogin\_brands](#onelogin_brands)
  ...
  - [Data Sources (using resource id)](#data-sources-using-resource-id)
    - [onelogin\_api\_authorizations\_instance](#onelogin_api_authorizations_instance)
...
- id [integer] - (Optional) Auth server unique ID in Onelogin
